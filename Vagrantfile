...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sebics-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/chef-test2"
  #   chef.validation_client_name = "chef-test2-validator"
  #   chef.validation_key_path = ".chef/chef-test2-validator.pem"
  # end
end
